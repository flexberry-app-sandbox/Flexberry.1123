...
namespace IIS.1123
{
    ...
    public class ЗаказПост : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.1123.СостОплаты fСостояниеОплаты;
        
        private bool fСуммаВклНДС;
        
        private int fСуммаДокумента;
        
        private IIS.1123.СостОтгрузки fСостОтгрузки;
        ...
        private IIS.1123.DetailArrayOfТЧЗаказ fТЧЗаказ;
        ...
        public virtual IIS.1123.СостОтгрузки СостОтгрузки
        {
            get
            {
                ...
                IIS.1123.СостОтгрузки result = this.fСостОтгрузки;
        ...
        public virtual IIS.1123.СостОплаты СостояниеОплаты
        {
            get
            {
                ...
                IIS.1123.СостОплаты result = this.fСостояниеОплаты;
        ...
        public virtual IIS.1123.DetailArrayOfТЧЗаказ ТЧЗаказ
        {
            get
            {
                ...
                {
                    this.fТЧЗаказ = new IIS.1123.DetailArrayOfТЧЗаказ(this);
                }
                IIS.1123.DetailArrayOfТЧЗаказ result = this.fТЧЗаказ;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЗаказПостE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаказПостE", typeof(IIS.1123.ЗаказПост));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЗаказПостL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаказПостL", typeof(IIS.1123.ЗаказПост));
                }
            }
        }
    }
