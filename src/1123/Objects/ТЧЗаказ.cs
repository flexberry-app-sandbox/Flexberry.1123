...
namespace IIS.1123
{
    ...
    public class ТЧЗаказ : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.1123.Номенклатура fНоменклатура;
        
        private IIS.1123.ЗаказПост fЗаказПост;
        ...
        [PropertyStorage(new string[] {
                "Номенклатура"})]
        [NotNull()]
        public virtual IIS.1123.Номенклатура Номенклатура
        {
            get
            {
                ...
                IIS.1123.Номенклатура result = this.fНоменклатура;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.1123.ЗаказПост.
        /// </summary>
        ...
        [TypeUsage(new string[] {
                "IIS.1123.ЗаказПост",
                "IIS.1123.ОтчетОЗак"})]
        public virtual IIS.1123.ЗаказПост ЗаказПост
        {
            get
            {
                ...
                IIS.1123.ЗаказПост result = this.fЗаказПост;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТЧЗаказE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТЧЗаказE", typeof(IIS.1123.ТЧЗаказ));
                }
            }
        }
    }
    ...
    public class DetailArrayOfТЧЗаказ : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.1123.DetailArrayOfТЧЗаказ members)

        // *** End programmer edit section *** (IIS.1123.DetailArrayOfТЧЗаказ members)
        ...
        /// </summary>
        public DetailArrayOfТЧЗаказ(IIS.1123.ЗаказПост fЗаказПост) : 
                base(typeof(ТЧЗаказ), ((ICSSoft.STORMNET.DataObject)(fЗаказПост)))
        {
        }
        
        public IIS.1123.ТЧЗаказ this[int index]
        {
            get
            {
                return ((IIS.1123.ТЧЗаказ)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.1123.ТЧЗаказ dataobject)
        {
