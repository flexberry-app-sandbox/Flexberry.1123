...
namespace IIS.1123
{
    ...
    [View("ОтчетОЗакL", new string[] {
            ...
            "СуммаДокумента as \'Сумма документа\'",
            "ДатаНачала as \'Дата начала\'"})]
    public class ОтчетОЗак : IIS.1123.ЗаказПост
    {
        ...
        public override IIS.1123.СостОтгрузки СостОтгрузки
        {
            get
            {
                ...
                IIS.1123.СостОтгрузки result = base.СостОтгрузки;
        ...
        public override IIS.1123.СостОплаты СостояниеОплаты
        {
            get
            {
                ...
                IIS.1123.СостОплаты result = base.СостояниеОплаты;
        ...
        public override IIS.1123.DetailArrayOfТЧЗаказ ТЧЗаказ
        {
            get
            {
                ...
                IIS.1123.DetailArrayOfТЧЗаказ result = base.ТЧЗаказ;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ОтчетОЗакE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОтчетОЗакE", typeof(IIS.1123.ОтчетОЗак));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ОтчетОЗакL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОтчетОЗакL", typeof(IIS.1123.ОтчетОЗак));
                }
            }
        }
    }
