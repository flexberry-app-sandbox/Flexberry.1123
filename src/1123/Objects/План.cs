...
namespace IIS.1123
{
    ...
    public class План : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.1123.ПланЗакупок fПланЗакупок;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.1123.ПланЗакупок.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "ПланЗакупок"})]
        public virtual IIS.1123.ПланЗакупок ПланЗакупок
        {
            get
            {
                ...
                IIS.1123.ПланЗакупок result = this.fПланЗакупок;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПланE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПланE", typeof(IIS.1123.План));
                }
            }
        }
    }
    ...
    public class DetailArrayOfПлан : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.1123.DetailArrayOfПлан members)

        // *** End programmer edit section *** (IIS.1123.DetailArrayOfПлан members)
        ...
        /// </summary>
        public DetailArrayOfПлан(IIS.1123.ПланЗакупок fПланЗакупок) : 
                base(typeof(План), ((ICSSoft.STORMNET.DataObject)(fПланЗакупок)))
        {
        }
        
        public IIS.1123.План this[int index]
        {
            get
            {
                return ((IIS.1123.План)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.1123.План dataobject)
        {
